...
public class QuickCodeInspector {
    ...
    private static void render(final File textFile) {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
              ...
              try {
                highlighter.setContent(textFile);
    ...
    // /home/tony/Desktop/QuickCodeInspector.java
    public static void main(String[] args) {
        QuickCodeInspector.render(new File(args[0]));
    }
