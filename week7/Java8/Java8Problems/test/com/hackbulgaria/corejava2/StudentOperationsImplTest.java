...
public class StudentOperationsImplTest {
    ...
    @Before
    public void setup() throws InitializationError, InstantiationException, IllegalAccessException,
        ...
        if (subtypes.size() > 1) {
            throw new InitializationError("One subclass of " + StudentOperations.class.getCanonicalName()
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getAllPassing()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getAllFailing()}.
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getAverageMark()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#splitStudentsByMarks(float)}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#orderByMarkDescending()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#orderByMarkAscending()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getMarksDistributionByAge()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getAverageMarkByGender()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getMarksDistribution()}
     * .
     */
    @Test
    ...
    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#getEmailToHeader()}
     * .
     */
    @Test
    public void testGetEmailToHeader() {
        ...
        assertEquals(expectedResult.replaceAll("\\s+", "").toLowerCase(), studentOperations.getEmailToHeader()
                .replaceAll("\\s+", "").toLowerCase());
    }

    /**
     * Test method for
     * {@link com.hackbulgaria.corejava2.StudentOperationsImpl#splitStudentMarksByGenderAndThenByAge()}
     * .
     */
    @Test
